 ...
 * Safetoken Fork! thx to 0f0crypto
 * added setMaxTxAmount, setBlackListed Fuction
 * Various Other Updates in Original Code
 */
...
*                             /|                      
*                             \|                      
*  Specialized by: AntCrew Network - https://antcrew.net
*  For: Unity Protocol - https://unitycol.net
*/
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "Unity Community";
    string internal constant SYMBOL = "UnityCom";
    ...
    uint256 public maxTransactionAmount = TOTAL_SUPPLY / 200; // 0.5% of the total supply
    ...
    address internal devAddress = 0xaEc8B5c55317f6a9f15839Ca7D3EC46C9AB31adf;
    ...
    function _addFees() private {
        ...
        _addFee(FeeType.External, 30, devAddress );
    }
...
abstract contract BaseRfiToken is IERC20, IERC20Metadata, Ownable, Presaleable, Tokenomics {
    ...
    function setBlackListed(address account, bool value) external onlyOwner { _isBlackListed[account] = value; }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
		...
		require(!_isBlackListed[sender], "BaseRfiToken: transfer from blacklisted");
		require(!_isBlackListed[recipient], "BaseRfiToken: transfer to blacklisted");
...
abstract contract UnityCom is BaseRfiToken, Liquifier, Antiwhale {
...
contract UnityCommunity is UnityCom{

    constructor() UnityCom(Env.MainnetV2){
